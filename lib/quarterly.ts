...
// 매출 = 학생수 × 63만, 영업이익 = 학생수 × 26만, 지출 = 매출 - 영업이익
export const myPnlSeries: QuarterPnl[] = [
  pnl(QUARTERS[0], 37_800_000, 22_200_000, 60),
  pnl(QUARTERS[1], 40_320_000, 23_680_000, 64),
  pnl(QUARTERS[2], 42_840_000, 25_160_000, 68),
  pnl(QUARTERS[3], 45_990_000, 27_010_000, 73),
  pnl(QUARTERS[4], 49_140_000, 28_860_000, 78),
];
